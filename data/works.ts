...
export const works: Work[] = [
  ...
  },
  {
    ...
    duration: "01:00",
    description:
      "AI 조연출 6명을 동시에 부려 영상을 제작하는 워크플로우. 한 명이 아니라 여러 AI 에이전트를 병렬로 운용해 라인워크와 피부 질감 디테일까지 끌어올리는 AInspire의 실전 제작 방식을 공개합니다.",
    youtubeId: "diUPZxd2x2w",
    thumbnail: yt("diUPZxd2x2w"),
    thumbnailColor: "from-slate-900 via-indigo-800 to-purple-900",
  },
  {
    id: "fintech-lipsync-ai-ad",
    title: "핀테크 립싱크 AI 광고",
    client: "Spec Project",
    ...
    duration: "00:30",
    description:
      "완벽한 립싱크와 연기까지 가능해진 4K AI 핀테크 광고. 실사 촬영 없이 AI만으로 인물의 입모양·표정·연기를 정교하게 구현한 워크 — 확대해서 봐도 자연스러운 디테일을 담았습니다.",
    youtubeId: "2rO2vcior1I",
    thumbnail: yt("2rO2vcior1I"),
    thumbnailColor: "from-blue-900 via-sky-800 to-cyan-900",
  },
  {
...
export const heroSlides: HeroSlide[] = [
  ...
  {
    id: 5,
    headline: "6 AI Directors",
    subline: "AI 조연출 6명을 동시에 부리는 제작 워크플로우",
    description: "여러 AI 에이전트를 병렬로 — 영상 제작의 새로운 방식",
    videoSrc: "/videos/hero-ai-directors.mp4",
  },
  {
    id: 6,
    headline: "Lip Sync",
    subline: "핀테크 AI 광고 — 연기까지 가능해진 4K 립싱크",
    description: "완벽한 입모양, AI가 연기하는 시대",
    videoSrc: "/videos/hero-fintech-lipsync.mp4",
  },
  {
    id: 7,
    headline: "Selective",
    subline: "Selective Brand Film — 8K 프리미엄 브랜드 필름",
    description: "AI로 빚어낸 브랜드의 정체성과 감성",
    videoSrc: "/videos/hero-selective.mp4",
  },
  {
    id: 8,
    headline: "Play the City",
    subline: "현대건설 — 미래 에너지 도시 캠페인",
    description: "도시를 Play하다, 미래 스마트 시티 비전",
    videoSrc: "/videos/hero-play-the-city.mp4",
  },
];
